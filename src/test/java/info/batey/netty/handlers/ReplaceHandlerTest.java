...
public class ReplaceHandlerTest {
    ...
    public void shouldNotStoreNewKey() throws Exception {
        //given
        MemcacheReplaceMessage message = new MemcacheReplaceMessage("notexist", 0, 0, new byte[] {123});
    ...
    public void shouldStorePreviouslySetKey() throws Exception {
        ...
        String key = "exists";
        byte[] data = {123};
        MemcacheReplaceMessage message = new MemcacheReplaceMessage(key, 0, 0, data);
